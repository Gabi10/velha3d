...
print("oi")
#A equação da reta.
#b = 0 então nossa equação é y = a*x, y = -1*x a outra  é: y =
...
TIRAS =  [[(x*SP, y*SP, z*SP) for x in TAM] for y in TAM for z in TAM]+[
    ...
    [(x*SP, y*SP, z*SP) for z in TAM] for x in TAM for y in TAM]+[
         [(x*SP,y*SP) for y in TAM] for x in TAM for z in TAM]+[
             [(-9,9,z),(0,0,z),(9,-9,z)] for z in [-9,0,9]]+[
            [(9,9,z),(0,0,z),(-9,-9,z)] for z in  [-9,0,9]]


         #[(-9,9,9)],(0,0,9),(9,-9,9),[(9,9,9),(0,0,9),(-9,-9,9)]]+[
         #[(-9,9,0)],[(0,0,-9),(9,9,0),[(9,-9,-9),(0,0,-9),(-9,-9,0)]]+[
         #[(-9,9,0),(0,0,0),(9,-9,0)],[(9,9,0),(0,0,0),(-9,-9,0)]]
